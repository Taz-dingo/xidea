...
`docs/` 按“当前操作层优先、流程次之、参考材料靠后”的原则组织。

## First Stop

- [spec.md](spec.md): 当前阶段要证明什么
- [status.md](status.md): 现在已经做到哪里
- [plan.md](plan.md): 接下来优先做什么
- [memory/](memory): 长期记忆、决策与开放问题
...
- [reference/learning-engine-backend-integration.md](reference/learning-engine-backend-integration.md)
...
这些文档用于补背景，不是默认 source of truth。

## Archive

- [archive/collaboration.md](archive/collaboration.md): 较早期的协作草案，保留供回看
- [archive/decision-log-history.md](archive/decision-log-history.md): 较早阶段的历史决策记录
