      ...
      <div className="relative pt-7">
        {queuedActivities
          ...
          .map((activity, index) => {
            ...
            return (
              <div
                className="pointer-events-none absolute inset-x-6 rounded-[1.2rem] border border-[var(--xidea-selection-border)] bg-[linear-gradient(180deg,#fffaf5_0%,#f8eee8_100%)] shadow-[0_18px_40px_rgba(124,82,57,0.08)]"
                key={activity.id}
                style={{
              ...
              >
                <div className="space-y-2 px-4 py-4 opacity-80">
